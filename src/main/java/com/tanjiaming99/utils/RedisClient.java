...
public class RedisClient {
    ...
    private static final long DEFAULT_EXPIRE_SECOND = 600;
     ...
     * @return true 成功 false失败
     */
    public boolean hset(String key, Map<String, Object> item) {
        try {
     ...
     * @return true 成功 false失败
     */
    public boolean hset(String key, Map<String, Object> item, long time) {
        try {
            redisTemplate.opsForHash().putAll(key, item);
            if (time > 0) {
                expire(key, time);
